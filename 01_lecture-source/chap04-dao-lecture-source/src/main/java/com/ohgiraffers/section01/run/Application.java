...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("등록 메뉴의 이름을 입력해 주세요 : ");
        String menuName = sc.nextLine();
        System.out.println("등록 메뉴의 가격을 입력해주세요 : ");
        int menuPrice = sc.nextInt();
        System.out.println("등록 메뉴의 카테고리를 입력해 주시오 : ");
        sc.nextLine();
        ...
        String orderableStatement = "";
        switch (answer) {
            case "예" : orderableStatement = "Y"; break;
            case "아니오" : orderableStatement = "N"; break;
        }

        MenuDTO newMenu = new MenuDTO(menuCode, menuName, menuPrice, categoryCode, orderableStatement);
